...
from ..utils import get_config, get_gunicorn_conf_path, stop_previous_container, CONTAINER_NAME, IMAGE_NAME
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Test app. From Meinheld with Gunicorn. Using Python 3.7",
        ),
        ("latest.dockerfile", "Test app. From Meinheld with Gunicorn. Using Python 3.7"),
        (
